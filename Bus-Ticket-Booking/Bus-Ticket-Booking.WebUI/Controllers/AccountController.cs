    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await _emailSender.SendEmailAsync(model.Email, "Travel Confirm Account!", $"Lütfen email adresinizi onaylamak için <a href='https://localhost:5001{url}'>tıklayınız!</a>");
